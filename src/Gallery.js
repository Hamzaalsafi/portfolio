...
export function Gallery({images}) {
  ...
  return (
    ...
    ref={scrollRef} className="relative rounded-xl flex items-center justify-center w-full h-full">
      ...
      <div className="absolute bottom-4 left-1/2  transform -translate-x-1/2 flex space-x-2">
        {images.map((_, index) => (
          ...
          animate={{
            ...
            backgroundColor: currentIndex === index ? 'rgba(239, 68, 68, 1)' : 'rgba(209, 213, 219, 1)', // Using rgba here
          }}
          transition={{
            type: 'tween',
            ease: "easeOut",
