...
export function Nav({Home,Projects}) {
  ...
  return (
    <div className={`w-screen text-md md:text-xl gap-3 md:gap-5  ${mode==="dark"?"text-gray-200":"text-black"} h-14 md:justify-center items-center flex relative navbar`}>
  {["Home", "Projects", "Skills", "About", "Contact"].map((section) => (
    <h1
      ...
      className={`border-0 text-nav hover:scale-110 py-1
        ...
        ${
        activeSection === section ? "border-b-2 " : "border-b-2 border-transparent"
